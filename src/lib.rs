...
mod tests {
    ...
    fn it_works() {
        ...
        println!("{:?}", &url);*/
        /*let search = Doujishi::new(316932).unwrap(); // On fait une recherche sur cette url
        println!("{:#?}", search.tags);*/
        ...
        /*let page = crate::doujishi::Doujishi::new(search.entries[0].id).unwrap(); // On prend la première page de la recherche
        ...
        /*let doujin = Doujishi::new(327341).unwrap();
        println!("{:#?}", doujin);*/
